...
document.querySelector('.toggleFiltersDropdown').addEventListener('click', toggleFiltersDropdown);
document.querySelector('.closeFiltersDropdown').addEventListener('click', closeFiltersDropdown);
